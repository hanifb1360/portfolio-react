...
const WordPressProject = ({ wordPressProject }) => {
        ...
        {showDetails && (
          ...
          >
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: wordPressProject.description }}
            />

            {wordPressProject && wordPressProject.technologies && (
              <ul className={styles.projectTech}>
                {wordPressProject.technologies.map((tech, index) => (
            ...
            <div className={styles.projectLinks}>
              <a
                ...
                href={wordPressProject.demoLink}
